...
{
    /// <summary>
    /// Consumes messages from a RabbitMQ topic exchange using a specific multi-level routing key pattern.
    /// </summary>
    public class ConsumerTopic2Exchange
    {
        /// <summary>
        /// Connects to RabbitMQ, declares a topic exchange and queue, binds them with a multi-level routing key pattern,
        ...
        public async Task CallConsumerAsync()
        {
            ...
            // Bind the queue to the exchange with the multi-level routing key pattern
            ...
            consumer.ReceivedAsync += async (sender , ea) =>
            {
                ...
                Console.WriteLine($"Received (Topic2): {message}");
            ...
            Console.WriteLine("ConsumerTopic2Exchange is listening for messages...");
